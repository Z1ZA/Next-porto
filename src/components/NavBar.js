...
const NavBar = () => {
  ...
  return (
    <header className="dark:text-light w-full px-32 py-8 font-medium flex items-center justify-between relative z-10 lg:px-12 sm:px-8">
      <button
      ...
      <div className="flex w-full justify-between items-center lg:hidden">
        ...
        <nav className="flex justify-center items-center flex-wrap">
          ...
          <motion.a
            href="www.linkedin.com/in/abdaziz1"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 mx-3"
